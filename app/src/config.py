...
class Config:
    ...
    MAX_BUY_ATTEMPTS_PER_WINDOW = int(os.environ.get("MAX_BUY_ATTEMPTS_PER_WINDOW", "5"))
    BUY_RATE_LIMIT_WINDOW_SECONDS = int(os.environ.get("BUY_RATE_LIMIT_WINDOW_SECONDS", "60"))